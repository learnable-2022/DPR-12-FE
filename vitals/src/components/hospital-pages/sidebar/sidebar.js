              ...
              <nav className='nav'>
                ...
                <div className={`header-toggle`} onClick={() => {setShow(!show);}}>
                  ...
                  <div className='nav-list'>
                    <NavLink to='/hcp-dashboard' className='nav-link'>
                      <DashboardOutlinedIcon className='nav-link-icon' />
                      <span className='nav-logo-name'>Dashboard</span>
                    </NavLink>
                    <NavLink to='/hcp-doctors' className='nav-link'>
                      <GroupOutlinedIcon className='nav-link-icon' />
                      <span className='nav-logo-name'>Doctors</span>
                    </NavLink>
                    <NavLink to='/hcp-patients' className='nav-link'>
                      <PeopleAltIcon className='nav-link-icon' />
                ...
                <div className='details-container'>
                  <div>
                    <NavLink to={'/hcp-login'} className='nav-link'>
